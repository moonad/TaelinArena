...
(async function fetch_image() {
  heroes_image.set("benfix", (await import("./assets/images/benfix.png")).default);
  heroes_image.set("bleskape", (await import("./assets/images/bleskape.png")).default);
  heroes_image.set("chamusco", (await import("./assets/images/chamusco.png")).default);
  heroes_image.set("darthvader", (await import("./assets/images/darthvader.png")).default);
  heroes_image.set("dilma", (await import("./assets/images/dilma.png")).default);
  heroes_image.set("dorime", (await import("./assets/images/dorime.png")).default);
  heroes_image.set("drstrange", (await import("./assets/images/drstrange.png")).default);
  heroes_image.set("escanos", (await import("./assets/images/escanor.png")).default);
  heroes_image.set("finn", (await import("./assets/images/finn.png")).default);
  heroes_image.set("gastly", (await import("./assets/images/gastly.png")).default);
  heroes_image.set("gon", (await import("./assets/images/gon.png")).default);
  heroes_image.set("greninja", (await import("./assets/images/greninja.png")).default);
  heroes_image.set("greenlantern", (await import("./assets/images/greenlantern.png")).default);
  heroes_image.set("grimer", (await import("./assets/images/grimer.png")).default);
  heroes_image.set("jacquin", (await import("./assets/images/jacquin.png")).default);
  heroes_image.set("jinx", (await import("./assets/images/jinx.png")).default);
  heroes_image.set("ivyklaws", (await import("./assets/images/ivyklaws.png")).default);
  heroes_image.set("kakashi", (await import("./assets/images/kakashi.png")).default);
  heroes_image.set("kenko", (await import("./assets/images/kenko.png")).default);
  heroes_image.set("kirby", (await import("./assets/images/kirby.png")).default);
  heroes_image.set("kingdedede", (await import("./assets/images/kingdedede.png")).default);
  heroes_image.set("konan", (await import("./assets/images/konan.png")).default);
  heroes_image.set("linainverse", (await import("./assets/images/linainverse.png")).default);
  heroes_image.set("link", (await import("./assets/images/link.png")).default);
  heroes_image.set("loki", (await import("./assets/images/loki.png")).default);
  heroes_image.set("luffy", (await import("./assets/images/luffy.png")).default);
  heroes_image.set("magnamite", (await import("./assets/images/magnamite.png")).default);
  heroes_image.set("mando", (await import("./assets/images/mando.png")).default);
  heroes_image.set("marthalynch", (await import("./assets/images/marthalynch.png")).default);
  heroes_image.set("mechwarrior", (await import("./assets/images/mechwarrior.png")).default);
  heroes_image.set("mikegator", (await import("./assets/images/mikegator.png")).default);
  heroes_image.set("min", (await import("./assets/images/min.png")).default);
  heroes_image.set("monica", (await import("./assets/images/monica.png")).default);
  heroes_image.set("pichu", (await import("./assets/images/pichu.png")).default);
  heroes_image.set("pingo", (await import("./assets/images/pingo.png")).default);
  heroes_image.set("ppg", (await import("./assets/images/ppg.png")).default);
  heroes_image.set("ray", (await import("./assets/images/ray.png")).default);
  heroes_image.set("ryu", (await import("./assets/images/ryu.png")).default);
  heroes_image.set("scorpion", (await import("./assets/images/scorpion.png")).default);
  heroes_image.set("shao", (await import("./assets/images/shao.png")).default);
  heroes_image.set("shonkie", (await import("./assets/images/shonkie.png")).default);
  heroes_image.set("squirtle", (await import("./assets/images/squirtle.png")).default);
  heroes_image.set("srmadruga", (await import("./assets/images/srmadruga.png")).default);
  heroes_image.set("steve", (await import("./assets/images/steve.png")).default);
  heroes_image.set("teichi", (await import("./assets/images/teichi.png")).default);
  heroes_image.set("teresa", (await import("./assets/images/teresa.png")).default);
  heroes_image.set("tvee", (await import("./assets/images/tvee.png")).default);
  heroes_image.set("tonystark", (await import("./assets/images/tonystark.png")).default);
  heroes_image.set("tophoro", (await import("./assets/images/tophoro.png")).default);
  heroes_image.set("tupitree", (await import("./assets/images/tupitree.png")).default);
  heroes_image.set("weedle", (await import("./assets/images/weedle.png")).default);
  heroes_image.set("xululuchild", (await import("./assets/images/xululuchild.png")).default);
  heroes_image.set("yusuke", (await import("./assets/images/yusuke.png")).default);
  heroes_image.set("zagatur", (await import("./assets/images/zagatur.png")).default);
  heroes_image.set("zed", (await import("./assets/images/zed.png")).default);
  heroes_image.set("zoio", (await import("./assets/images/zoio.png")).default);
})();
