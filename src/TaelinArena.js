...
(async function fetch_image() {
  ...
  heroes_image.set("chamusco", (await import("./assets/chamusco.png")).default);
  ...
  heroes_image.set("escanos", (await import("./assets/escanor.png")).default);
  ...
  heroes_image.set("greenlantern", (await import("./assets/greenlantern.png")).default);
  ...
  heroes_image.set("pingo", (await import("./assets/pingo.png")).default);
  ...
  heroes_image.set("shonkie", (await import("./assets/shonkie.png")).default);
